...
namespace BookmarkMergeTool
{
    ...
    static class BookmarkReader
    {
        ...
        /// <returns></returns>
        private static Folder CreateFolder(string labelName, string line, Component prevComponent)
        {
            string labelText = "";
            int addDate = 0;
            int lastModified = 0;
            ...
            return new Folder(labelName, labelText, addDate, lastModified, prevComponent, personalToolbarFolder);
        }
        ...
        /// <param name="prevComponent"></param>
        /// <returns></returns>
        private static Bookmark CreateBookmark(string line, Component prevComponent)
        {
            ...
            return new Bookmark("A", labelText, href, addDate, icon, prevComponent);
        }
